...
// @grant		none
// ==/UserScript==
const siteURL = "https://gist.githubusercontent.com/seigo2016/b1893ec633ca73ff801596b74ec66256/raw/d4385002aba1fa19d1501d90aa0872a2ea0edd01/gsi4d_rule.json"

fetch(siteURL).then(response => response.json())
.then(site => {
	console.log(site);
	const SearchTypes = {
		Default:	'',
